...
func (dc *DepartmentCreate) AddExpertIDs(ids ...int) *DepartmentCreate {
	dc.mutation.AddExpertIDs(ids...)
	return dc
}

// AddExperts adds the "experts" edges to the Expert entity.
func (dc *DepartmentCreate) AddExperts(e ...*Expert) *DepartmentCreate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return dc.AddExpertIDs(ids...)
}

// AddTicketIDs adds the "tickets" edge to the Ticket entity by IDs.
func (dc *DepartmentCreate) AddTicketIDs(ids ...int64) *DepartmentCreate {
...
func (dc *DepartmentCreate) createSpec() (*Department, *sqlgraph.CreateSpec) {
	...
	if nodes := dc.mutation.ExpertsIDs(); len(nodes) > 0 {
