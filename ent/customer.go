...
func (e CustomerEdges) TicketsOrErr() ([]*Ticket, error) {
	if e.loadedTypes[0] {
...
func (*Customer) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case customer.FieldUsername, customer.FieldFirstName, customer.FieldLastName:
...
// QueryTickets queries the "tickets" edge of the Customer entity.
func (c *Customer) QueryTickets() *TicketQuery {
	return NewCustomerClient(c.config).QueryTickets(c)
}
